...
export const CLOTHING = [
  ...
  item('shirt-sky', 'top', 'shirt', 'Oxford blue shirt', '#A9C1DB', { tags: ['casual'], price: 80 }),
  ...
  item('sweater-rust', 'top', 'sweater', 'Rust knit sweater', '#B8664A', { tags: ['winter', 'cozy'], price: 120 }),
  ...
  item('jacket-leather', 'outer', 'jacket', 'Leather jacket', '#2A2427', { tags: ['date'], price: 220, rarity: 'rare' }),
  item('blazer-char', 'outer', 'blazer', 'Charcoal blazer', '#3B3E4C', { tags: ['formal'], price: 160 }),
  item('cardigan-cream', 'outer', 'cardigan', 'Cream cardigan', '#E9DCC6', { tags: ['cozy'] }),
  item('puffer-sage', 'outer', 'puffer', 'Sage puffer', '#8FA890', { tags: ['winter'], price: 180 }),
  item('kimono-floral', 'outer', 'kimono', 'Festival kimono', '#D98E96', { tags: ['festival'], accent: '#F2C98B', price: 150, rarity: 'rare' }),

  // Dresses
  item('dress-sun', 'dress', 'sundress', 'Butter sundress', '#EFD58F', { tags: ['beach', 'casual'] }),
  item('dress-evening', 'dress', 'evening', 'Midnight slip dress', '#2B2F4A', { tags: ['date', 'formal'], price: 260, rarity: 'rare' }),
  item('dress-wine', 'dress', 'evening', 'Wine slip dress', '#7A2E3F', { tags: ['date'], price: 260, rarity: 'rare' }),
  item('dress-knit', 'dress', 'knit', 'Oat knit dress', '#CDBBA2', { tags: ['winter', 'cozy'] }),
  item('dress-floral', 'dress', 'floral', 'Lilac floral dress', '#C9B8E6', { tags: ['festival', 'date'], accent: '#F5EBDD', price: 140 }),
  ...
  item('trousers-cream', 'bottom', 'pants', 'Linen trousers', '#E3D6C1', { tags: ['beach', 'casual'], price: 90 }),
  ...
  item('skirt-pleat', 'bottom', 'skirt', 'Pleated cream skirt', '#EAE0CF', { tags: ['casual'], price: 70 }),
  ...
  item('heels-black', 'shoes', 'heels', 'Black heels', '#1F1C22', { tags: ['date', 'formal'], price: 120 }),
  item('loafers', 'shoes', 'loafers', 'Brown loafers', '#6B432E', { tags: ['formal'] }),
  item('slippers', 'shoes', 'slippers', 'Bunny slippers', '#F2E9EE', { tags: ['pajamas'], price: 60 }),
  ...
  item('glasses-heart', 'glasses', 'heart', 'Heart shades', '#C45E74', { tags: ['festival'], price: 90, rarity: 'rare' }),
  item('hat-beanie', 'hat', 'beanie', 'Rust beanie', '#B8664A', { tags: ['winter'] }),
  item('hat-cap', 'hat', 'cap', 'Navy cap', '#2D3A5A', { tags: ['casual'] }),
  item('hat-beret', 'hat', 'beret', 'Wine beret', '#7A2E3F', { tags: ['date'], price: 80 }),
  item('hat-sun', 'hat', 'sunhat', 'Straw sun hat', '#D8BC8A', { tags: ['beach'], accent: '#3B3E4C' }),
  item('hat-flowers', 'hat', 'flowers', 'Flower crown', '#E8B4A0', { tags: ['festival'], accent: '#B8A7D9', price: 110, rarity: 'rare' }),
  item('ear-studs', 'earrings', 'studs', 'Gold studs', '#E8C27A', { tags: ['casual'] }),
  item('ear-hoops', 'earrings', 'hoops', 'Gold hoops', '#E8C27A', { tags: ['date'] }),
  item('ear-pearls', 'earrings', 'pearls', 'Pearl drops', '#F5EFE6', { tags: ['formal'], price: 100 }),
  item('neck-pendant', 'necklace', 'pendant', 'Little heart pendant', '#E8C27A', { tags: ['date'] }),
  item('neck-pearls', 'necklace', 'pearls', 'Pearl strand', '#F5EFE6', { tags: ['formal'], price: 140, rarity: 'rare' }),
